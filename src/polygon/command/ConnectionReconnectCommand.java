...
public class ConnectionReconnectCommand extends Command {
	...
	private PolyPoint newSource;
	/** The new target endpoint. */
	private PolyPoint newTarget;
	/** The original source endpoint. */
	private final PolyPoint oldSource;
	/** The original target endpoint. */
	private final PolyPoint oldTarget;
	 ...
	 *             if conn is null
	 */
	public ConnectionReconnectCommand(PolyConnection conn) {
		if (conn == null) {
	...
	private boolean checkSourceReconnection() {
		...
		for (Iterator iter = newSource.getSourceConnections().iterator(); iter
				.hasNext();) {
			PolyConnection conn = (PolyConnection) iter.next();
	 ...
	 */
	public void setNewSource(PolyPoint connectionSource) {
	 ...
	 */
	public void setNewTarget(PolyPoint connectionTarget) {
